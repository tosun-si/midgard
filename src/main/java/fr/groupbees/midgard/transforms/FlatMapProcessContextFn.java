 ...
 *
 * <p>
 * If there are errors in the process, an failure Tag based on {@link fr.groupbees.midgard.Failure} object is used to handle
...
public class FlatMapProcessContextFn<InputT, OutputT> extends BaseElementFn<InputT, OutputT> {
     ...
     * @return a {@link fr.groupbees.midgard.transforms.FlatMapProcessContextFn} object
     */
